...
from experiments.evaluator.datasets.math_code_dataset import MathCodeDataset
import os
...
async def main():
    ...
    dataset_train = MathCodeDataset('dev')
    dataset_val = MathCodeDataset('val')
    ...
    limit_questions = 17 if debug else 100
    ...
    if mode == 'DirectAnswer':
        ...
        edge_probs = await evaluator.optimize_swarm_ppo(num_iters=num_iters, lr=lr)
